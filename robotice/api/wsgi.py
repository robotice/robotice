...
api_group = cfg.OptGroup('robotice_api')
...
api_cfn_group = cfg.OptGroup('robotice_api_cfn')
...
api_cw_group = cfg.OptGroup('robotice_api_cloudwatch')
...
def list_opts():
    ...
    yield 'robotice_api', api_opts
    yield 'robotice_api_cfn', api_cfn_opts
    yield 'robotice_api_cloudwatch', api_cw_opts
...
class Server(object):
    ...
    def __init__(self, threads=1000):
        ...
        self.conf = cfg.CONF.robotice_api
